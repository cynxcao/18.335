...
class UniformFMM:
    ...
    # def build_tree(self, node):
    #     # stop if too many levels OR few bodies
    #     # if node.level==self.max_level or len(node.src_idx)<=self.leaf_capacity:
    #     #     return
    #     if node.level == self.max_level:
    #         return
    #     h = node.radius/2
